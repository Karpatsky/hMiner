...
public class Gui extends javax.swing.JFrame {
    ...
    public Gui() {
        ...
        ArrayList<String> smeltLocations = new ArrayList<String>();
        for (Furnaces ore : Furnaces.values()) {
            smeltLocations.add(ore.getName());
        }
        smeltLocation.setModel(new DefaultComboBoxModel(smeltLocations.toArray(new String[smeltLocations.size()])));
        ArrayList<String> barNames = new ArrayList<String>();
        for (Bars ore : Bars.values()) {
            barNames.add(ore.name());
        }
        smeltBar.setModel(new DefaultComboBoxModel(barNames.toArray(new String[barNames.size()])));
        setupBoxes(45, 7);

    }
    private AIOMiner aioMiner = null;

    public void setAioMiner(AIOMiner aioMiner) {
